...
+ **data**: This folder contains several datasets including 2013 and 2016 core sets to reproduce the reported results. We also provide a toy set with 50 examples (the whole training set is too large) to explain how to train EHIGN model from scratch. 
...
+ **test.py**, Test a trained model on 2013 and 2016 core sets and print the results.
